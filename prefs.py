...
def get_prefs(session: requests.Session):
    ...
    if Data.prefGymNameEN == "Qimo":
        ...
        Data.viewbookURL = format_viewbook_url(
            Data.prefGymID, Data.prefItemID, Data.book_date
        )
