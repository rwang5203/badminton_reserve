...
# Payment Method
# (0 for On-site Payment, 1 for Online Payment)
paymentmethod = 0

# Format Headers and URL
def format_viewbook_url(GYM_ID, ITEM_ID, BOOK_DATE):
...
def format_captcha_header(SERVER_ID, JSESSION_ID, GYM_ID, ITEM_ID, BOOK_DATE):
    captcha_header = {
...
def format_book_header(SERVER_ID, JSESSION_ID, GYM_ID, ITEM_ID, BOOK_DATE):
    book_header = {
...
def format_book_data(COSTS, INDEX, TOKENS, PHONE_NUMBER, GYM_ID, ITEM_ID, BOOK_DATE, CAPTCHA_LABEL, PAYMENT_METHOD):
    book_data = {
...
def format_pay_header(SERVER_ID, JSESSION_ID):
    pay_header = {
